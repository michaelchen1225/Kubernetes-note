...
這個系列共 31 篇文章，一天一篇可於一個月內讀完。內容主要聚焦於 CKA 的考試範圍，非考試範圍的內容可以參考另一個 repo：[Kubernetes notes](https://github.com/michaelchen1225/Kubernetes-note)
...
今天的內容會先介紹「雲原生」的概念並銜接到 Kubernetes 的起源與發展，最後簡單介紹 CKA 的考試內容與章節規劃。
